...
<!--
What this file is:
Template for proposing features (components, tokens, or process improvements).

Who should edit it:
Product or Design owners when the feature intake process changes.

When to update (example):
Update if intake requires additional fields (e.g., business case).

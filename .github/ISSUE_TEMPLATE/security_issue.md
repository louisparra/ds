...
<!--
What this file is:
Security issue template - instructs reporters to use the private disclosure channel in SECURITY.md.

Who should edit it:
Design System Lead and Security team.

When to update (example):
Update when the security reporting process or contact changes.

Who must approve changes:
Security and Design System Lead.
-->

IMPORTANT: Do **not** report active or sensitive security vulnerabilities in a public issue. Follow the private disclosure process in `SECURITY.md`.

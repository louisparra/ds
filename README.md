<!--
What this file is:
Top-level README for the Design System TEMPLATE repo; explains purpose and where to start.

Who should edit it:
Design System Lead or Docs Owner; small clarifications may be made by contributors.

When to update (example):
Update when the template's top-level workflow or key entry points change.

Who must approve changes:
Design System Lead (for content changes that affect the project description).
-->

# Design System Template — Starter Repo
